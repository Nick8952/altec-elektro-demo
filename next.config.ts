...
//                                nick8952.github.io/altec-elektro-demo/. Baut ohne jede Env-Variable.
...
const nextConfig: NextConfig = {
  ...(istExport
    ...
    : {
        // Auf Vercel: alte Joomla-Adressen auf die neuen Seiten umleiten (Liste in data/weiterleitungen.json).
        async redirects() {
